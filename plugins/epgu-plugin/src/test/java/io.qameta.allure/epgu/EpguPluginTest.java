...
class EpguPluginTest {
    ...
    void storiesPerFeatureResultsAggregation() {
        ...
        TreeWidgetData behaviorsData = new EpguPlugin.WidgetAggregator()
    ...
    void shouldSortByStartTimeAsc() {
        ...
        final Tree<TestResult> tree = EpguPlugin.getData(Collections.singletonList(results));
